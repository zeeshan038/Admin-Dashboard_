        ...
        <div className="adminContainer"> 
            ...
            <main className="chart-container">
             ...
             <section>
                      ...
                      <div>
                        <PieChart labels = {["Processing" , "Shipped" , "Delivereds"]}
                        data={[12 , 9 , 13]}
                        backgroundColor={[
                          `hsl(110 , 80% , 80%)`,
                          `hsl(110 , 80% , 50%)` , 
                ...
                <h2>Product Catagories ratio</h2>
            </section>
            ...
            <section>
                ...
                <h2>Stock Availibility</h2>
            </section>

            <section>
                <div>
                  <DoughnutChart labels = {["Marketing Cost" , "Discount" , "Brunt" , "Production Cost" , "Net Margin"]}
                  data={[32, 18 , 5 , 20 , 25]}
            ...
            <section>
                <div>
                  <PieChart labels = {["Teenager(Below 20)" , "Adult(20-40)" , "Older(above 40)"]}
                  data={[12 , 259 , 13]}
                  backgroundColor={[
                    `hsl(10 , ${80}% , 80%)`,
                    `hsl(10 , ${80}% , 50%)` , 
